/** The mascot's raw shapes (32-unit viewBox coords), shared by the plain avatar
 *  and the costumed variants so the base creature is drawn exactly once. */
export function ClaudeMascotShapes() {
  return (
    <>
      {/* legs */}
